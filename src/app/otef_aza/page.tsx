...
export default function otefAaza({ }: Props) {
    return (
        <main className="main-content flex-col gc2">
            ...
            <Image className="Image" width={150} height={150} src="/otef_aza.webp" alt="" />
            <span className="Image-desc">בארי לאחר ההרס והחורבן עוטף עזה</span>
            ...
            <Image className="Image" width={150} height={150} src="/bar-mitzva.jpg" alt="" />
            <span className="Image-desc">בר מצווה מצב לימינלי חברתי</span>
            ...
            <span className="Image-desc">בצהוב(השטח שיועד למדינה הערבית) בכחול(השטח שיודע למדינה היהודית) בלבן(שטח בשליטה בנילאומית)  </span>
            ...
            <Image className="Image" width={150} height={150} src="/unscop1.jpg" alt="" />
            <span className="Image-desc">חברי וועדת אונסקופ UNSCOP</span>
            ...
            <Image className="Image" width={150} height={150} src="/11_points.webp" alt="" />
            <span className="Image-desc">11 ישובים קמים בלילה אחד</span>
            ...
            <Image className="Image" width={150} height={150} src="/settelment_in_the_naegev39-47.png" alt="" />
            <span className="Image-desc">התיישבות הציונית בנגב 1939-1947</span>
            <Image className="Image" width={150} height={150} src="/unscop2.jpg" alt="" />
            <span className="Image-desc">ועדת אונסקופ בביקור בישובי הנגב</span>
            ...
            <Image className="Image" width={150} height={150} src="/dancing_indpendnce.jpg" alt="" />
            <span className="Image-desc">רוקדים במעגלי הורה </span>
            <Image className="Image" width={150} height={150} src="/48war.jpeg" alt="" />
            <span className="Image-desc">מלחמת העצמאות 1948</span>
            ...
            <Image className="Image" width={150} height={150} src="/natan_alterman.jpeg" alt="" />
            <span className="Image-desc">נתן אלתרמן </span>
            ...
            <Image className="Image" width={150} height={150} src="/nahabir-beerri.png" alt="" />
            <span className="Image-desc">נח'ביר בארי הישנה הוקמה במקור קרוב יותר לגבול</span>
            <Image className="Image" width={150} height={150} src="/singel-beeri.jpg" alt="" />
            <span className="Image-desc">בארי נוף סחוף שבילי אופנים </span>
            ...
            <Image className="Image" width={150} height={150} src="/agriclture_from_the_air.png" alt="" />
            <span className="Image-desc">עוטף עזה תצלום לוויני</span>
            ...
            <Image className="Image" width={150} height={150} src="/byzantin_empire_6century.png" alt="" />
            <span className="Image-desc">האימפריה הביזנטית במאה השישית לספירה</span>
            ...
            <Image className="Image" width={150} height={150} src="/avdat.jpg" alt="" />
            <span className="Image-desc">גן לאומי עבדת </span>
            <Image className="Image" width={150} height={150} src="/mmshit.jpg" alt="" />
            <span className="Image-desc">גן לאומי ממשית</span>
            ...
            <Image className="Image" width={150} height={150} src="/החווה-החקלאית-המשוחזרת-ליד-עבדת.jpg" alt="" />
            <span className="Image-desc"> החווה החקלאית המשוחזרת ליד עבדת, ממחישה איך הבזנטים ניצלו את תוואי הנחלים לבניית טרסות</span>
            ...
            <Image className="Image" width={150} height={150} src="/Kolt_digging_mission.png" alt="" />
            <span className="Image-desc">משלחת החפירות של קולט לנגב</span>
            <Image className="Image" width={150} height={150} src="/Nitzana.jpg" alt="" />
            <span className="Image-desc">ניצנה הכנסייה הדרומית ובור המים</span>
            ...
            <Image className="Image" width={150} height={150} src="/Nitzana_archive.png" alt="" />
            <span className="Image-desc">המקום בו נמצאו הפפירוסים</span>
            <Image className="Image" width={150} height={150} src="/Nitzana_papiros.png" alt="" />
            <span className="Image-desc">פפירוס ניצנה מתאר התיישובות של יחידות צבאיות בנגב</span>
            <Image className="Image" width={150} height={150} src="/cheap_housing_for_army_people.png" alt="" />
            <span className="Image-desc">הטבות במגורים ובמיסים למתיישבים באזורי הגבול בימינו</span>
            ...
            <Image className="Image" width={150} height={150} src="/desert_tribs.png" alt="" />
            <span className="Image-desc">שבטי המדבר(אילוסטרציה)</span>
            ...
            <Image className="Image" width={150} height={150} src="/shivta_church _and_mosqe.png" alt="" />
            <span className="Image-desc">שיבטה במאה השביעית כנסייה ולידו מסגד</span>
            ...
            <Image className="Image" width={150} height={150} src="/nagev.jpg" alt="" />
            ...
            <Image className="Image" width={150} height={150} src="/beeri_not_coming_back.png" alt="" />
            <span className="Image-desc">...</span>
            <p>תרבויות שויתרו על הזהות שלהם על המנהגים שלהם על זיכרון הקולקטיבי שלהם פשוט נעלמו מעל דפי ההיסטוריה , כך קרה לפלישתים לנבטים ואפילו לרומאים. העם היהודי הוא דוגמה נפלאה בהיבט הזה, כיהודים אנחנו מצווים ב"הגת לבנך" שימור ההיסטוריה והסיפור שלנו כעם לא רק מלמד אותנו על ניסיונם של אלו שהיו כאן לפנינו אלא גם שומר עליינו חסונים ומלוכדים. עם ישראל חי.    </p>
            <p></p>
        </main>
    )
}