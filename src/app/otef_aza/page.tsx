...
export default async function otefAaza({ }: Props) {
    const sections = [
        { id: 'section-1', title: 'עוטף עזה שטח הפקר' },
        { id: 'section-2', title: 'עזה שטח ביניים' },
        { id: 'section-3', title: 'יישור קו לפני שממשיכים' },
        { id: 'section-4', title: 'תוכנית החלוקה של האום' },
        { id: 'section-5', title: 'ההתיישבות הציונית בעשור שקדם לקום המדינה' },
        { id: 'section-6', title: 'התגובה לתוכנית החלוקה של האום' },
        { id: 'section-7', title: 'נתן אלתרמן צריף בנגב' },
        { id: 'section-8', title: 'בארי כמקרה מבחן' },
        { id: 'section-9', title: 'העוטף מהאוויר' },
        { id: 'section-10', title: 'חקלאות מגדירה גבולות' },
        { id: 'section-11', title: 'ערי הנגב הביזאנטיות' },
        { id: 'section-12', title: 'קנקני עזה בעולם' },
        { id: 'section-13', title: 'איפה היה הצבא?' },
        { id: 'section-14', title: 'פפירוסי ניצנה' },
        { id: 'section-15', title: 'שורשיה של הקונספציה נעוצים בתקופה הביזנטית' },
        { id: 'section-16', title: 'הקונספציה קורסת עם הכיבוש הערבי' },
        { id: 'section-17', title: 'עול המיסוי של הכיבוש הערבי' },
        { id: 'section-18', title: 'החקלאות המודרנית  וחוסן חברתי בעוטף עזה' },
    ]
    return (
        <main className="main-content flex-col gc2">
                    <h2 id="section-1">עוטף עזה שטח הפקר</h2>

            <ProgressBar user={null} articel={'otef'}/>
            <p className="intro">פה ננסה להבין האם נכון לכנות את השטח שבו פועל הגדוד עוטף עזה?  איך הפך שטח בתחום הנגב המערבי בו הוקמו קיבוצים, מושבים וישובים קהילתיים, שחלקם בעיצוב הגבולות של מדינת ישראל היה גדול לאין שיעור, לשטח הפקר? ולמה הוא נקרא עוטף עזה?  למה לא  למשל יישובי הנגב המערבי? ולמה לא עוטף ישראל? , ולמה לא  נקרא בכל שם שמקשר את חבל הארץ הזה, למדינת ישראל. איך הפך עוטף עזה להיות שטח ישראלי שבשמו הוא קשור לישות אחרת ?  האם יכול להיות שהשם עוטף עזה השפיע על האופן שבה התייחסנו לשטח הזה? כאן ננסה לשאול גם, איך הפכה העיר עזה שהייתה משך מאות בשנים מקום מרכזי וחשוב מבחינה מסחרית ומדינית, למקום שאף אחד לא רוצה קשר אליו? ישראל לא רוצה שום קשר אליו, ונראה שגם מצריים. איך הפכה עזה למקום שכוח כה אפל שולט בו? </p>
            ...
            <h2 id="section-2">עזה שטח ביניים</h2>
            ...
            <h2 id="section-3">יישור קו לפני שממשיכים </h2>
            ...
            <h2 id="section-4">תוכנית החלוקה של האום</h2>
            ...
            <h2 id="section-5">ההתיישבות הציונית בעשור שקדם לקום המדינה </h2>
            ...
            <h2 id="section-6">התגובה לתוכנית החלוקה של האום</h2>
           ...
           <ArticleImage width={150} height={150} src={"/new_aggriment.png"} alt="רצועת עזה כולל העבסאנים בדרום(בצהוב), נחל שקמה (באדום) והגיאולוג פארקר" 
            ...
            <h2 id="section-7">נתן אלתרמן צריף בנגב</h2>
            ...
            <h2 id="section-8">בארי כמקרה מבחן </h2>
            ...
            <h2 id="section-9">העוטף מהאוויר</h2>
            ...
            <h2 id="section-10">חקלאות מגדירה גבולות </h2>
            ...
            <h2 id="section-11">ערי הנגב הביזאנטיות </h2>
           ...
           <ArticleImage width={150} height={150} src={"/mmshit.jpg"} alt="גן לאומי ממשית" 
            ...
            <h2 id="section-12">קנקני עזה בעולם</h2>
            ...
            <h2 id="section-13">איפה היה הצבא?</h2>
            ...
            <h2 id="section-14">פפירוסי ניצנה</h2>
            ...
            <h2 id="section-15">שורשיה של הקונספציה נעוצים בתקופה הביזנטית</h2>
            ...
            <h2 id="section-16">הקונספציה קורסת עם הכיבוש הערבי</h2>
            ...
            <h2 id="section-17">עול המיסוי של הכיבוש הערבי</h2>
            ...
            <h2 id="section-18">החקלאות המודרנית  וחוסן חברתי בעוטף עזה</h2>
